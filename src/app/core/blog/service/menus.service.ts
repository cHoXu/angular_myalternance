...
export class MenusService {
  ...
  findMainBlogMenu(): Menu {
    return new Menu(1, 'Tous les articles', [
      new MenuItem(1, '/article/1', 'Trouver ma formation en alternance.', 1),
      new MenuItem(2, '/article/2', 'Préparer mon CV et ma lettre de motivation.', 1),
      new MenuItem(3, '/article/3', 'Comment postuler à des offres avec MyAlternance?', 1),
      new MenuItem(4, '/article/4', 'Préparer mon entretien d’embauche.', 1),
      new MenuItem(5, '/article/5', 'Conseils pour bien débuter en entreprise.', 1)
    ]);
  }
